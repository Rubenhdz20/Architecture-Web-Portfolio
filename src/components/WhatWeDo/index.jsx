        ...
        <section id='whatwedo' className='whatwedo'>
            ...
            <div className='whatwedo__container'>
                <div className='whatwedo__information'>
                    <img className='whatwedo__information--image img1' src="/assets/architecture.jpg" alt="" />
                    <p className='whatwedo__information--text p1'>Our team has a strong background in architecture and design, working on projects that range from single-family homes to large-scale commercial buildings.</p>
                </div>
                <div className='whatwedo__information'>
                    <img className='whatwedo__information--image' src="/assets/architecture.jpg" alt="" />

    ...
    return(
        <section id='whatwedo' className='whatwedo'>
            ...
            <div className='whatwedo__container'>
                ...
                <div className='whatwedo__information'>
                    <img className='whatwedo__information--image' src="dist/assets/remodelacion1.jpg" alt="remodelling image"/>
                ...
                <div className='whatwedo__information'>
                    <img className='whatwedo__information--image img1' src="dist/assets/design1.jpg" alt="Design Background"/>
                ...
                <div className='whatwedo__information'>
                    <img className='whatwedo__information--image' src="dist/assets/ampliacion1.jpg" alt="Extension"/>
